...
Map paras = getParasMap(request);
		...
		String output = productObj.updateProduct(paras.get("hidProductIDSave").toString(), paras.get("productCode").toString(), 
				paras.get("productName").toString(), paras.get("productPrice").toString(), paras.get("productDesc").toString(),paras.get("noOfUnits").toString(),paras.get("productType").toString());
