...
public class Product {
	...
	public String readProducts() {
		...
		try {
			...
			output = "<table border='1'><tr><th>Product Code</th><th>Product Name</th><th>Product Price</th><th>Product Description</th><th>No of Units</th>"
	...
	public String insertProduct(String code, String name, String price, String desc, String units,
			String type) {
		String output = "";
		try {
			Connection con = connect();
	...
	public String updateProduct(String ID, String code, String name, String price, String desc, String units,
			String type) {
		String output = "";
		try {
			Connection con = connect();
